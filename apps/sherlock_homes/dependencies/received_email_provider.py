...
from sherlock_homes.adapter.outbound.repositories.received_email_db_repository import ReceivedEmailDbRepository
...
def get_received_email_interactor(
    ...
    return ReceivedEmailInteractor(repo=ReceivedEmailDbRepository(session=db))
