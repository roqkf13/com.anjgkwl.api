...
from scout.app.ports.output.patch_translation_repository import PatchTranslationRepository
...
def get_game_detail_use_case() -> GameDetailUseCase:
    ...
    patch_translator: PatchNoteTranslator = GeminiPatchNoteTranslator(translation_store)
    mod_repository: ModRepository = CompositeModHttpRepository()
    return GameDetailInteractor(repository, steam_news, patch_translator, translation_store, mod_repository)
