from scout.app.schemas.game_detail_schema import (
    GameDetailSchema,
    ModSchema,
    PatchNoteSchema,
    RelatedVideoSchema,
...
_PATCH_NOTES_KO: dict[int, list[PatchNoteSchema]] = {
    2868840: [
        _patch_note(
...
def _default_patch_notes_ko(steam_app_id: int) -> list[PatchNoteSchema]:
